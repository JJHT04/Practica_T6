...
public class ColeccionLibros {
    ...
    private void aumentarEspacio() {
        tienda_V1.Libro[] aux = new tienda_V1.Libro[this.libros.length*2];
    ...
    public void eliminar(){
        ...
        if (this.index>1){
            ...
            if (this.index != Integer.parseInt(i)) {
                tienda_V1.Libro tmp;
                index--;
    ...
    public void modificar(){
        ...
        if (this.index>1){
            ...
            this.libros[Integer.parseInt(i)-1] = new tienda_V1.Libro(codigo, autor, titulo, genero, Integer.parseInt(numPaginas));
